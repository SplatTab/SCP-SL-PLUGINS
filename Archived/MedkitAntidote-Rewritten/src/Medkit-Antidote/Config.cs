...
namespace Medkit_Antidote
{
    public sealed class Config : IConfig
    {
        ...
        [Description("List of status effects which SCP-500 should remove from the player.")]
        public List<EffectType> SCP500EffectsToRemove { get; set; } = new List<EffectType> { EffectType.Concussed, EffectType.Panic, EffectType.Poisoned };
    }
}